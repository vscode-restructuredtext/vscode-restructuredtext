...
export class RSTPreview {
    ...
    public updateConfiguration() {
        if (
            this._previewConfigurations.hasConfigurationChanged(this._resource)
        ) {
            this.refresh();
        }
    }
    ...
    public toggleLock() {
        ...
        this.editor.title = RSTPreview.getPreviewTitle(
            this._resource,
            this._locked
        );
    }
    ...
    private async doUpdate(): Promise<void> {
        ...
        const content: string =
            await this._contentProvider.provideTextDocumentContent(
                document,
